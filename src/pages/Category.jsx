        ...
        <div style={{width:"80%"}}> {/*Right Part*/}
            ...
            <div className='border'>
                <div className="d-flex flex-wrap row my-4 mx-auto"> {/*product card*/}
                    <div className="col-3 mb-4">
                        <div className="card d-flex flex-wrap justify-content-end rounded-0" style={{width: "100%"}}>
                            ...
                            <div className="text-center position-absolute top-0 end-0 bg-secondary-subtle">
                                <h5 className="m-0 bg-light p-1">50% <br/> OFF</h5>                                    
                            </div>
                            <div className="mx-auto mt-2">
                                ...
                                <div className="my-2">
                                    <a className="btn text-light p-1 me-1" style={{backgroundColor: "rgb(255, 75, 153)"}} href=""><small><i class="bi bi-cart"></i> ADD TO CART</small></a>
                                    <a className="btn text-light p-1 ms-1" style={{backgroundColor: "rgb(255, 75, 153)"}} href=""><small><i className="bi bi-bag-heart"></i> BUY NOW</small></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-3 mb-4">
                        <div className="card d-flex flex-wrap justify-content-end rounded-0" style={{width: "100%"}}>
                            <img src={men2} height="300rem" className="card-img-top" alt="..."/>
                            <div className="text-center position-absolute top-0 end-0 bg-secondary-subtle">
                                <h5 className="m-0 bg-light p-1">50% <br/> OFF</h5>
                            </div>
                            <div className="mx-auto mt-2">
                    ...
                    <div className="col-3 mb-4">
                        <div className="card d-flex flex-wrap justify-content-end rounded-0" style={{width: "100%"}}>
                            <img src={men3} height="300rem" className="card-img-top" alt="..."/>
                            <div className="text-center position-absolute top-0 end-0 bg-secondary-subtle">
                                <h5 className="m-0 bg-light p-1">50% <br/> OFF</h5>
                            </div>
                            <div className="mx-auto mt-2">
                    ...
                    <div className="col-3 mb-4">
                        <div className="card d-flex flex-wrap justify-content-end rounded-0" style={{width: "100%"}}>
                            <img src={men4} height="300rem" className="card-img-top" alt="..."/>
                            <div className="text-center position-absolute top-0 end-0 bg-secondary-subtle">
                                <h5 className="m-0 bg-light p-1">50% <br/> OFF</h5>
                            </div>
                            <div className="mx-auto mt-2">
                    ...
                    <div className="col-3 mb-4">
                        <div className="card d-flex flex-wrap justify-content-end rounded-0" style={{width: "100%"}}>
                            <img src={men5} height="300rem" className="card-img-top" alt="..."/>
                            <div className="text-center position-absolute top-0 end-0 bg-secondary-subtle">
                                <h5 className="m-0 bg-light p-1">50% <br/> OFF</h5>
                            </div>
                            <div className="mx-auto mt-2">
