                            ...
                            <div className="container-fluid overflow-hidden">
                                <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                                    ...
                                    <div className="col-12 col-lg-3 col-xl-4">
                                        <div className="widget">
                                            <h5 className="widget-title mb-4">Our Newsletter</h5>
                                                ...
                                                <div className="row gy-4">
                                                    ...
                                                    <div className="col-12">
                                                        <div className="d-grid">
                                                            <button className="btn cs-btn-primary" type="submit">Subscribe</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                ...
                                <div className="row gy-4 gy-md-0">
                                    <div className="col-xs-12 col-md-7 order-1 order-md-0">
                                        ...
                                        <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
                                            Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">Dreel Digital</a> with <span className="text-primary">&#9829;</span>
                                        </div>
                                    </div>
