      ...
      <div className='w-100 px-3 mt-3'>
        ...
        <div className='container mt-4'>
          <div className='d-flex align-items-center flex-column'>
            <input className='mb-3 w-50 p-2 border rounded rounded-0' type="text" onChange={(e)=>{setEmail(e.target.value)}} placeholder='Enter new password here..' />
            <input className='mb-3 w-50 p-2 border rounded rounded-0' type="text" onChange={(e)=>{setEmail(e.target.value)}} placeholder='Enter password again here..' />
            <button className='mb-3 bg-danger text-light w-50 p-1 border-0 rounded-0' onClick={handleSignIn}>Save Password</button>
          </div>
