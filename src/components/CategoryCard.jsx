...
export default function CategoryCard() {
  return (
    <div className='col-lg-2 col-6 p-2 cs-btn-primary border border-3 border-white'>
      <Link to={'/category/random'} style={{textDecoration:'none',color:'white'}}>
        ...
        <div className='pt-3'>
            <h1 className='fs-5 fw-light text-center card-title'>Women's Ethinic Wear</h1>
            <h2 className='fs-2 fw-bold text-center card-dis'>30-70% OFF</h2>
