  ...
  return (
    <div className='row py-5 m-0'>
        <div className='col-lg-7'>
            ...
            <HomeInfo align={"start"} title={'Join the Fashion Fusion Community'} desc={"Join our community of fashion enthusiasts and trendsetters to share your style inspiration, connect with like-minded individuals, and be the first to know about exclusive offers and promotions. Sign up for our newsletter to receive updates straight to your inbox and unlock special discounts on your favorite fashion finds."}/>
            <HomeInfo align={"start"} title={'Experience Fashion Fusion Today'} desc={"Whether you're seeking timeless classics or the hottest trends of the season, Fashion Fusion is your ultimate destination for all things fashion. Start exploring our collection now and discover the perfect pieces to elevate your style and make a statement wherever you go."}/>
        </div>
